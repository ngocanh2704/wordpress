...
<div <?php fl_woocommerce_version_check( '3.4.0' ) ? wc_product_class( $classes ) : post_class( $classes ); ?>>
	...
	<div class="product-small box <?php echo flatsome_product_box_class(); ?>">
		<div class="box-image">
			...
			<div class="mh-image-tools mh-fex-row image-tools <?php echo flatsome_product_box_actions_class(); ?>">
				<?php do_action( 'flatsome_product_box_actions' ); ?>
        		<a class="mh-detail-product" href="<?php the_permalink(); ?>">Xem chi tiết</a>
