...
if ( ! defined( 'WPINC' ) ) {die;}
	...
	if( !class_exists( 'Wow_Side_Menu_Class' ) ) {
		class Wow_Side_Menu_Class
		{				
			function __construct() {
				$this->name = 'Wow Side Menu';
				$this->version = '3.1.2';				
			...
			public function side_menu_notice() {
				...
				<div class="notice notice-success" style="position: relative;">
					...
					<p>Did you know, that Side Menu has a fancy new replacement called <strong><a href="https://wordpress.org/plugins/side-menu-lite/" target="_blank">Side Menu Lite</a></strong>? We hope you enjoy using Side Menu Lite for user attention-grabbing!.</p>
					<ul class="ul-square">
						...
						<li><a href="https://wordpress.org/plugins/side-menu-lite/" target="_blank">Learn more</a> or <a href="<?php echo esc_url( $url ); ?>">Install it now!</a></li>
					</ul>
				</div>
		...
		$plugin = new Wow_Side_Menu_Class();		
	}			